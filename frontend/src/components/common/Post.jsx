	...
	mutationFn: async ()=>{
        try {
           const res= await fetch(`${baseUrl}/api/post/delete/${post._id}`,{
            ...
            return toast.error("Failed to delete post"+error.message);
        }
    },
    onSuccess: () => {
	...
	mutationFn: async ()=>{
        try {
           const res= await fetch(`${baseUrl}/api/post/like/${post._id}`,{
            ...
            return toast.error("Failed to like post"+error.message);
        }
    },
...
const {mutate:commentPost, isPending:isCommenting}=useMutation({
	mutationFn: async ({comment})=>{
        try {
            ...
            return toast.error("Failed to comment post"+error.message);
        }
    },
	onSuccess: () => {
